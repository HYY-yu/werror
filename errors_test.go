...
// werror.New, etc values are not expected to be compared by value
// but the change in werror#27 made them incomparable. Assert that
// various kinds of werror have a functional equality operator, even
